                                                                    ...
                                                                    foreach ($productos_datos as $productos_dato) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <script>
                                                                                    $('#btn_selecionar<?php echo $id_producto; ?>')
                                                                                        .click(function() {


                                                                                            var id_producto =
                                                                                                "<?php echo $productos_dato['id_producto']; ?>";
                                                                                            $('#id_producto').val(
                                                                                                id_producto);

                                                                                            var codigo =
                                                                                                "<?php echo $productos_dato['codigo']; ?>";
                                                                                            $('#codigo').val(codigo);

                                                                                            var categoria =
                                                                                                "<?php echo $productos_dato['categoria']; ?>";
                                                                                            ...
                                                                                            var email =
                                                                                                "<?php echo $productos_dato['email']; ?>";
                                                                                            $('#usuario_producto').val(
                                                                                                email);
                                                                                            ...
                                                                                            var stock_minimo =
                                                                                                "<?php echo $productos_dato['stock_minimo']; ?>";
                                                                                            $('#stock_minimo').val(
                                                                                                stock_minimo);

                                                                                            var stock_maximo =
                                                                                                "<?php echo $productos_dato['stock_maximo']; ?>";
                                                                                            $('#stock_maximo').val(
                                                                                                stock_maximo);

                                                                                            var precio_compra =
                                                                                                "<?php echo $productos_dato['precio_compra']; ?>";
                                                                                            $('#precio_compra').val(
                                                                                                precio_compra);
                                                                                            ...
                                                                                            var fecha_ingreso =
                                                                                                "<?php echo $productos_dato['fecha_ingreso']; ?>";
                                                                                            $('#fecha_ingreso').val(
                                                                                                fecha_ingreso);

                                                                                            var ruta_img =
                                                                                                "<?php echo $URL . '/almacen/img_productos/' . $productos_dato['imagen']; ?>";
                                                                                            $('#img_producto').attr({
                                                                                                src: ruta_img
                                                                                            });

                                                                                            $('#modal-buscar_producto')
                                                                                                .modal('toggle');
                                    ...
                                    <div class="row" style="font-size: 12px">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <center>
                                                    <img src="<?php echo $URL . "/almacen/img_productos/" .  $productos_dato['imagen']; ?>" id="img_producto" width="50%" alt="">
                                                </center>
                                            </div>
                                        </div>
                                    </div>
                                                                    ...
                                                                    foreach ($proveedores_datos as $proveedores_dato) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <script>
                                                                                    $('#btn_selecionar_proveedor<?php echo $id_proveedor; ?>')
                                                                                        .click(function() {
                                                                            ...
                                                                            <td><?php echo $proveedores_dato['telefono']; ?>
                                                                            </td>
                                                                            <td><?php echo $proveedores_dato['empresa']; ?>
                                                                            </td>
                                                                            <td><?php echo $proveedores_dato['email']; ?>
                                                                            </td>
                                                                            <td><?php echo $proveedores_dato['direccion']; ?>
                                                                            </td>
                                                                        </tr>
                                                                    <?php
                                                                    }
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button class="btn btn-primary btn-block" id="btn_guardar_compra">Guardar
                                                compra</button>
                                        </div>
                                    </div>
                                    <script>
